...
// 設定
$mail_to = 'shin.sasao@gmail.com	'; // フォームデータを受け取るメールアドレス
$mail_subject = 'ギークガレージお問い合わせフォームメール送信'; // 受け取る時のSubject（件名）
$reply_subject = 'ギークガレージお問い合わせフォームメールより自動返信です'; // 送信者へ自動返信のSubject（件名）
